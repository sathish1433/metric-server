...
## Deployment
In order to deploy metrics-server in your kubernetes master machine clone https://github.com/sathish1433/metric-server.git  and run the following command from
